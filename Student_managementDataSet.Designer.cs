...
namespace project_10_3.Student_managementDataSetTableAdapters {
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Students] WHERE (([id] = @Original_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([birthday] = @Original_birthday) AND ([gender] = @Original_gender) AND ([phone] = @Original_phone) AND ([address] = @Original_address))";
...
SELECT id, first_name, last_name, birthday, gender, phone, address, picture FROM Students WHERE (id = @id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Students] SET [id] = @id, [first_name] = @first_name, [last_name] = @last_name, [birthday] = @birthday, [gender] = @gender, [phone] = @phone, [address] = @address, [picture] = @picture WHERE (([id] = @Original_id) AND ([first_name] = @Original_first_name) AND ([last_name] = @Original_last_name) AND ([birthday] = @Original_birthday) AND ([gender] = @Original_gender) AND ([phone] = @Original_phone) AND ([address] = @Original_address));
SELECT id, first_name, last_name, birthday, gender, phone, address, picture FROM Students WHERE (id = @id)";
        ...
        public virtual int Fill(Student_managementDataSet.StudentsDataTable dataTable) {
        ...
        public virtual Student_managementDataSet.StudentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Student_managementDataSet.StudentsDataTable dataTable = new Student_managementDataSet.StudentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Student_managementDataSet.StudentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_first_name, string Original_last_name, System.DateTime Original_birthday, string Original_gender, int Original_phone, string Original_address) {
        ...
        public virtual int Insert(int id, string first_name, string last_name, System.DateTime birthday, string gender, int phone, string address, byte[] picture) {
        ...
        public virtual int Update(int id, string first_name, string last_name, System.DateTime birthday, string gender, int phone, string address, byte[] picture, int Original_id, string Original_first_name, string Original_last_name, System.DateTime Original_birthday, string Original_gender, int Original_phone, string Original_address) {
